...
## **Compatibility**
This texture pack is **compatible with version 1.21.9 and above** as well as **any specific mod loader (e.g. OptiFine, Fabric, Forge, etc. It doesn't require any, really.)** so download it, plop it into your resource pack folder and enjoy the game with a lot more flare than before!

Older versions are compatible with 1.21.5 and below.

## **Latest Information** 
- Latest **Official Release** ---> **[1.2.5-1.21.5-8](https://modrinth.com/resourcepack/rustees-glamorous-textures/version/1.2.5+1.21.5-8)**
- Latest **Pre-Release** ---> **[1.3.2beta1.0](https://modrinth.com/resourcepack/rustees-glamorous-textures/version/1.3.2-beta1.0)**
- Preview future content here ---> [Rustee's Laboratory!](https://modrinth.com/resourcepack/rustees-lab)
...
- Wanna know how I design these? Check out my **[YouTube](https://www.youtube.com/@IAmRustee)**!
- Support my work by buying me a **[Kofi](https://ko-fi.com/iamrustee)**!
...
- Anyone claiming to be me, IAmRustee, and reuploading my stuff in any other platform aside from the following: [Youtube](https://www.youtube.com/@IAmRustee), Modrinth, CurseForge, Twitter, and Discord, is an impersonator and should not be trusted about existing, and upcoming content for RGT.

# NO AI!
- **I strictly do not consent to the use of all content from this project as training data for AI content generation.**
- This project uses **absolutely 0 AI generated content** for the art and the code. All information contained in this project is purely human-made, derived from the [Official Minecraft Wiki](https://minecraft.wiki/), and some code inspired by other texture pack creators (credited in certain updates).
...
- Discord: iamrustee
- Gmail 1: wewen305@gmail.com
- Gmail 2: rusteethepixelartist@gmail.com